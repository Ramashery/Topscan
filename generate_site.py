...
# Label of the "back" button on a full-screen team profile (mobile). Used when
# pages/about has no `back` string yet; add `back` to translations.<lang> to override.
ABOUT_BACK_DEFAULT = {"en": "Back", "de": "Zurück", "ka": "უკან", "ru": "Назад"}
...
def gen_about(data):
    ...
    for lang in SUPPORTED_LANGS:
        ...
        t["back"] = t.get("back") or ABOUT_BACK_DEFAULT.get(lang, "Back")
        footer_labels = build_footer_labels(data, lang)
