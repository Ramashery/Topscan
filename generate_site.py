...
def lang_urls_for(path_per_lang_fn):
    """path_per_lang_fn(lang) -> url path (no leading BASE_URL). Returns a
    dict {lang: '/en/...'} for the header/footer language switcher."""
    return {l: path_per_lang_fn(l) for l in SUPPORTED_LANGS}
        ...
        services_json = json.dumps([
            {
                ...
                "bullets": sv["bullets"], "href": f"/{lang}/services/{sv['slug']}", "video": sv["video"],
            }
